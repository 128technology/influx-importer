...
// Metrics describes all metrics within the system.
var Metrics = []MetricDescriptor{
	...
	MetricDescriptor{
		...
		Description: "The number of exceptions received during packet action processing in the Fast Lane after flow table hit",
	...
	MetricDescriptor{
		...
		Description: "The number of exceptions received during packet action processing in the Fast Lane after fib table hit",
	...
	MetricDescriptor{
		ID:          "arp/entries",
		Description: "The number of active ARP entries",
		Label:       "Active ARP entries",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
	...
	MetricDescriptor{
		...
		Description: "The number of BFD packets received where the payload size is smaller than the minimum BFD packet size",
	...
	MetricDescriptor{
		...
		Description: "The number of packets received where the length of the BFD header is greater than the size of the packet",
	...
	MetricDescriptor{
		ID:          "session/flow/active",
		Description: "The number of active flows",
		Label:       "Active Flows",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
	...
	MetricDescriptor{
		ID:          "session/add",
		Description: "Total number of added sessions",
		Label:       "Added Sessions",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "session/remove",
		Description: "Total number of removed sessions",
		Label:       "Removed Sessions",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "session/added-existing",
		Description: "The number of duplicate flow entries during creation. This is a normal occurrence when a flow cannot be installed before the next packet arrives. The first packet that created the flow has not yet created a flow entry. Subsequent packets will cause this counter to be incremented.",
	...
	MetricDescriptor{
		ID:          "disk/capacity",
		Description: "Total disk capacity (bytes)",
		Label:       "Total disk capacity",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "disk/used",
		Description: "Total disk used (bytes)",
	...
	MetricDescriptor{
		...
		Description: "The number of packets received from the Fast Lane while not subscribed on the external protocol channel",
		Label:       "External Protocol Early Inbound Errors",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "external-protocols/manager/errors/early-outbound",
		Description: "The number of packets received from the External Protocol Manager while not subscribed on the external protocol channel",
	...
	MetricDescriptor{
		...
		Description: "The number of packets outbound from the Control received. These may be dropped and therefore outbound minus outbound-drop equals the number of successfully sent packets",
		Label:       "Outbound External Protocol's Packets Received",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "external-protocols/manager/packets/inbound",
		Description: "The number of packets inbound from the Fast Lane received. These may be dropped and therefore inbound minus inbound-drop equals the number of successfully sent packets",
	...
	MetricDescriptor{
		...
		Description: "The number of outbound packets from the External Protocol Manager that were an ARP or Neighbor Discovery reply and were therefore dropped",
	...
	MetricDescriptor{
		...
		Description: "The number of packets going through the External Protocol Agent and that had an illegal ethertype and were therefore dropped",
	...
	MetricDescriptor{
		...
		Description: "The number of packets going through the External Protocol Agent and that were IP packets but for which an external protocol was not found and were therefore dropped",
		Label:       "External Protocol's Illegal IP Drop Errors",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "external-protocols/agent/errors/fastlane-not-ready-drop",
		Description: "The number of outbound packets from the External Protocol Manager that were sent before the Fast Lane was ready to transmit and were therefore dropped",
		Label:       "External Protocol's Fastlane Not Ready Drop Errors",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "external-protocols/agent/errors/session-collision",
		Description: "The number of packets going through the External Protocol Agent that should have created a session but which collided with another process while creating the session and therefore were dropped",
		Label:       "External Protocol's Session Collision Errors",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
		ID:          "external-protocols/agent/errors/global-interface-lookup-drop",
		Description: "The number of inbound packets from the Fast Lane to the External Protocol Manager that encountered a global interface lookup failure and were therefore dropped",
	...
	MetricDescriptor{
		ID:          "routing/routes",
		Description: "The number of active routes",
		Label:       "Active Routes",
		Keys:        []string{"node"},
	},
	MetricDescriptor{
...
// FindMetricByID finds a MetricDescriptor for a given ID
func FindMetricByID(ID string) *MetricDescriptor {
